...
function dowork1(){
	...
	if(check_html($xmlobj['un1']['data1'])&&($xmlobj['un1']['data1']=="")){
		//error_dump($str);
		write_json::create_massage(array("username","bucunzai","string","1","1","1"));
		exit();
		
		
	}else if(check_html($xmlobj['un2']['data2'])&&($xmlobj['un2']['data2']=="")){
...
$xml=new massage_xml();
	...
	$shenqing=$shenqing.$xml->prase_xml1(array("name"=>"power","data"=>'chen',"power"=>$xmlobj['un2']['data2']),"body");
