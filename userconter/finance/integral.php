...
$gg=$xmlobj['un1']['data'];
	if(strlen($gg)>2&&($xmlobj['un1']['data']=="")){
		//error_dump($str);
	...
	try{
$resul= 	$xml->array_prase_xml2(array("hand"=>array("name"=>"denglu","error"=>"0","handle_type"=>"s"),"body"=>array("name"=>"finance","name1"=>"jifen","data"=>"chenguan","paytype"=>$xmlobj['un1']['data'],"amcash"=>$xmlobj['un2']['data'],"paypower"=>$xmlobj['un3']['data'])), "root");
