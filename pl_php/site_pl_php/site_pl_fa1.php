...
site_pl_fa1();
	function site_pl_fa1(){
	    ...
	    if(check_html($xmlobj['site_id'])&&($xmlobj['site_id']=="")){
		//error_dump($str);
	...
	if(check_html($xmlobj['super_id'])&&($xmlobj['super_id']=="")){
	    ...
	    echo "ds";
	if(check_html($xmlobj['data'])&&($xmlobj['data']=="")){
		//error_dump($str);父辈的id
		write_json::create_massage(array("username","bucunzai","string","1","1","1"));
		exit();
