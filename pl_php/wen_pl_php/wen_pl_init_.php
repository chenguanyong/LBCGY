...
wen_pl_init_();
	...
	function wen_pl_init_(){
	
		if(isset($_POST['wen_id'])&&($_POST["wen_id"]=="")){
	   ...
	   //[wen_id],[owername],[parntname],[data],[pl_id],xu,cha)
	   	$post=array("name"=>"wenpl","name1"=>"initpl","username"=>$username);
	   	$post["wen_id"]=$_POST['wen_id'];
...
//print_r($this->data_array);
	...
	FOREACH($this->data_array as $rtt){
		...
		$m->insert1(array("insert into wenpl ",$red));
	}
