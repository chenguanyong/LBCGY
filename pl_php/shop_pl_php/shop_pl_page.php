...
$mysql=new mysqli_("username");
		$result=$mysql->read("SELECT  `owername`,`parntname`,`data1`,`createtime`, `mas_type`,`tj`,`hf`,`pl_id`,`id1`  FROM `linbei_work`.`shoppl`  where shop_id='".$link_id."' and  pici =".$pici." LIMIT ".$page.", 20 ;");
