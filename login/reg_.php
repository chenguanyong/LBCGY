...
function checkf($ew){
	$yazheng=session_data::getsession(session_id(),'ya_reg');
	if($ew['un1']['data']==""){
	...
	else if(!check_name(strip_tags($ew['un1']['data']))){
		//echo "鐢ㄦ埛鍚嶅紓甯�;
		echo $ew['un1']['data'];
	...
	}else if($ew['un3']['data']!=$yazheng){

		write_json::create_massage(array("yan","buheguige","string","1","1","1"));
		exit();
